...
function createTemplates(objectTemplate) {
    ...
    MyTemplate = objectTemplate.create('MyTemplate', {
        ...
        please: {
            type: String, value: 'init', get: function (v) {
...
describe('Type Tests', function () {
    ...
    it('controller.myNumber is 1', function (done) {
        ...
        clientController.doServer('myNumber', 1, 2).then(function () {
            done();
        });
    });
    ...
    it('controller.myNumber is 0', function (done) {
        ...
        clientController.doServer('myNumber', 0, null).then(function () {
            done();
        });
    });
    ...
    it('controller.myNumber is 0', function (done) {
        clientController.myNumber = 0;
        clientController.doServer('myNumber', 0, 1).then(function () {
            done();
        });
    });
    ...
    it('controller.myNumber is 0', function (done) {
        ...
        clientController.doServer('myNumber', null, 0).then(function () {
            done();
        });
    });
    ...
    it("controller.myString is 'foo'", function (done) {
        ...
        clientController.doServer('myString', 'foo', 'bar').then(function () {
            done();
        });
    });
    ...
    it('controller.myString is null', function (done) {
        ...
        clientController.doServer('myString', null, 'foo').then(function () {
            done();
        });
    });
    ...
    it("controller.myString is 'bar'", function (done) {
        ...
        clientController.doServer('myString', 'bar', null).then(function () {
            done();
        });
    });
    ...
    it("controller.myDate is 'January 14, 2014'", function (done) {
        ...
        clientController.doServer('myDate', new Date('January 15, 2014'), new Date('January 15, 2015')).then(function () {
            done();
        });
    });
    ...
    it('controller.myDate is null', function (done) {
        ...
        clientController.doServer('myDate', null, new Date('January 15, 2014')).then(function () {
            done();
        });
    });
    ...
    it("controller.myDate is 'January 15, 2015'", function (done) {
        ...
        clientController.doServer('myDate', new Date('January 15, 2015'), null).then(function () {
            done();
        });
    });
    ...
    it('controller.myArrayTObj is t1, t2', function (done) {
        ...
        clientController.doServer('myArrayTObj', [t1, t2], [t1]).then(function () {
            done();
        });
    });
    ...
    it('controller.myArrayTObj is null', function (done) {
        ...
        t2.myNumber = null;
        clientController.doServer('myArrayTObj', null, [t2]).then(function () {
            done();
        });
    });
    ...
    it('controller.myArrayTObj is t2, t1', function (done) {
        ...
        clientController.doServer('myArrayTObj', [t2, t1], null).then(function () {
            done();
        });
    });
    ...
    it('controller.myArrayObj is {t: 1}, {t: 2}', function (done) {
        ...
        clientController.doServer('myArrayObj', [{t: 1}, {t: 2}], [{t: 1}]).then(function () {
            done();
        });
    });
    ...
    it('controller.myArrayObj is null', function (done) {
        ...
        clientController.doServer('myArrayObj', null, [{t: 2}]).then(function () {
            done();
        });
    });
    ...
    it('controller.myArrayObj is {t: 2}, {t: 1}', function (done) {
        ...
        clientController.doServer('myArrayObj', [{t: 2}, {t: 1}], null).then(function () {
            done();
        });
    });
    ...
    it("controller.myObj is {foo: 'one'}", function (done) {
        ...
        clientController.doServer('myObj', {foo: 'one'}, {foo: 'two'}).then(function () {
            done();
        });
    });
    ...
    it('controller.myObj is null', function (done) {
        ...
        clientController.doServer('myObj', null, {foo: 'one'}).then(function () {
            done();
        });
    });
    ...
    it("controller.myObj is {foo: 'two'}", function (done) {
        ...
        clientController.doServer('myObj', {foo: 'two'}, null).then(function () {
            done();
        });
    });
